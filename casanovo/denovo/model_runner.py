...
class ModelRunner:
    ...
    def initialize_model(self, train: bool, db_search: bool = False) -> None:
        ...
        model_params = dict(
            ...
            isolation_window_width=self.config.isolation_window_width,
            isolation_window_offset=self.config.isolation_window_offset,
            ...
            self_cond_layers=self.config.self_cond_layers,
            self_cond_weight=self.config.self_cond_weight,
